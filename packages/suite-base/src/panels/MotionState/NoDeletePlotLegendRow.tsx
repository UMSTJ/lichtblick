...
import { PlotPath, plotPathDisplayName } from "@lichtblick/suite-base/panels/Plot/utils/config";
...
export function NoDeletePlotLegendRow({
  ...
  return (
    ...
    >
      ...
      <div className={classes.actionButton} style={{ visibility: "hidden" }} >
        {index === paths.length ? (
