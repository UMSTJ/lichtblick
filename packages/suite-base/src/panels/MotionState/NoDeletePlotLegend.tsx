...
import { NoDeletePlotLegendRow, ROW_HEIGHT } from "./NoDeletePlotLegendRow";
import { PlotPath, PlotConfig } from "@lichtblick/suite-base/panels/Plot/utils/config";
...
function NoDeletePlotLegendComponent(props: Props): React.JSX.Element {
  const {
    coordinator,
    legendDisplay,
    onClickPath,
...
export const NoDeletePlotLegend = React.memo(NoDeletePlotLegendComponent);
