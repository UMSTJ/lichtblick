              ...
              secondaryAction={
                <Stack direction="row" spacing={1}>
                  {editingPointId === point.id ? (
                    <>
                      <IconButton size="small" onClick={handleEditSave} title="保存">
                        <Save24Regular />
                      </IconButton>
                      <IconButton size="small" onClick={handleEditCancel} title="取消">
                        <Dismiss24Regular />
                      </IconButton>
                    </>
                  ) : (
                    <>
                      <IconButton
                        size="small"
                        onClick={() => {
                          onPointVisibilityChange(point.id);
                        }}
